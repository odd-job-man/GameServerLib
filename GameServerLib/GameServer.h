...
public:
	...
	void EnqPacket(ULONGLONG id, Packet* pPacket); // 모아서 보내고 싶을때 SendQ에 Enque만 하고 WSASend는 호출하고 싶지 않을때 사용
	...
	const SOCKADDR_IN* GetSockAddrIn(ULONGLONG sessionID); // 사용자가 직접 black ip등을 등록할때 사용 가능함
